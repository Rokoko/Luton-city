...
// Cross Module References
	...
	SMARTSUIT_API UFunction* Z_Construct_UFunction_ASmartsuitReceiver_FQuatToRotator();
	COREUOBJECT_API UScriptStruct* Z_Construct_UScriptStruct_FRotator();
	COREUOBJECT_API UScriptStruct* Z_Construct_UScriptStruct_FQuat();
	SMARTSUIT_API UFunction* Z_Construct_UFunction_ASmartsuitReceiver_GetProp();
	SMARTSUIT_API UScriptStruct* Z_Construct_UScriptStruct_FProp();
	SMARTSUIT_API UFunction* Z_Construct_UFunction_ASmartsuitReceiver_GetTracker();
	SMARTSUIT_API UScriptStruct* Z_Construct_UScriptStruct_FTracker();
	SMARTSUIT_API UFunction* Z_Construct_UFunction_ASmartsuitReceiver_StartListener();
	SMARTSUIT_API UFunction* Z_Construct_UFunction_ASmartsuitReceiver_StopListener();
	SMARTSUIT_API UFunction* Z_Construct_UFunction_ASmartsuitReceiver_UPosition();
...
// End Cross Module References
	...
	IMPLEMENT_CLASS(ASmartsuitReceiver, 929551950);
