...
// Cross Module References
	...
	SMARTSUIT_API UFunction* Z_Construct_UFunction_ASmartsuitController_Broadcast();
	SMARTSUIT_API UFunction* Z_Construct_UFunction_ASmartsuitController_Calibrate();
	SMARTSUIT_API UFunction* Z_Construct_UFunction_ASmartsuitController_DoTests();
	SMARTSUIT_API UFunction* Z_Construct_UFunction_ASmartsuitController_GetBodyModel();
	SMARTSUIT_API UFunction* Z_Construct_UFunction_ASmartsuitController_Restart();
	SMARTSUIT_API UFunction* Z_Construct_UFunction_ASmartsuitController_SetBodyModel();
	SMARTSUIT_API UFunction* Z_Construct_UFunction_ASmartsuitController_Unicast();
...
static struct FScriptStruct_Smartsuit_StaticRegisterNativesFBodyModel
{
	...
	IMPLEMENT_CLASS(ASmartsuitController, 1231134176);
